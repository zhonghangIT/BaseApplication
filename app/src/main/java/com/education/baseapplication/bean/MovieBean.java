package com.education.baseapplication.bean;
...
public class MovieBean {
    ...
    @SerializedName("onShowStatus")
    private String onShowStatus;
    @SerializedName("lowPrice")
    private String lowPrice;
    @SerializedName("logo180320")
    private Object logo180320;
    @SerializedName("logo520692")
    private String logo520692;
    @SerializedName("highBoxOffice")
    private Object highBoxOffice;
    @SerializedName("stillsList")
    private Object stillsList;
    @SerializedName("mobilePreview")
    private String mobilePreview;
    @SerializedName("isAvailableInCurrentCity")
    private String isAvailableInCurrentCity;
    @SerializedName("isScheduleSupport")
    ...
    public void setLogo180320(Object logo180320) {
        this.logo180320 = logo180320;
    }
